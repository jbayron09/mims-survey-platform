      ...
      <main className="py-12">
        <div className="container">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-600">Choose a survey to participate in and share your valuable feedback.</p>
          </div>
              ...
              {surveys.map((survey) => (
                <div key={survey.id} className="card hover:shadow-lg transition-shadow group">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="text-sm text-gray-500">{new Date(survey.createdAt).toLocaleDateString()}</span>
                  </div>
